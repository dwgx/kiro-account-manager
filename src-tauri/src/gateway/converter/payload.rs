use crate::gateway::models::{
    ConversationState, CurrentMessage, HistoryItem, HistoryUserMessage, KiroPayload,
    NormalizedMessage, NormalizedRequest, UserInputMessage, UserInputMessageContext,
};
use reqwest::Client;
...
use super::content::{
    clean_system_prompt, extract_text_content, extract_tool_results,
    extract_tool_results_from_tool_message, join_with_double_newline,
};
use super::history::{
    build_history_assistant_message, build_user_context, has_empty_thinking_signature,
    merge_adjacent_messages, normalized_message_has_tool_results,
    order_tool_results_like_previous_tool_uses, sanitize_history,
};
use super::images::{extract_images, images_option};
use super::model_id::{get_internal_model_id, get_internal_model_id_with_fallback};
use super::tools::{convert_tools, normalize_tool_choice, process_tools_with_long_descriptions};
