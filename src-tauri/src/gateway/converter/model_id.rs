use crate::gateway::models::ModelInfo;
...
/// - 特殊值：auto
pub(super) fn is_kiro_supported_model_format(model: &str) -> bool {
    if model == "auto" {
        return true;
    }
...
/// - 已经是点号格式的直接返回
pub(super) fn normalize_claude_model_format(model: &str) -> String {
...
pub(super) fn normalize_external_model_alias(external_model: &str) -> String {
